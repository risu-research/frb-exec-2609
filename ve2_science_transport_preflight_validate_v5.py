...
"""V5 preflight adjudicator: frozen v4 law plus exact projection obligations."""
...
OUT_SCHEMA = "replaymark.ve2.science-transport-bootstrap-preflight-adjudication.v5"
PROJECTION_ID = "replaymark.ve2.registry-witness-exact-object-projection.v1"


def verify(path: Path) -> dict[str, Any]:
    # Reuse v4's complete registry and zero-invocation proof obligations while
    # changing only the admitted implementation identity.
    ...
    base.require(projection.get("execution_semantics_changed_from_v4") is False, "projection changed execution semantics")
